...
st.set_page_config(page_title="Tambah Data SPK", page_icon="🛒", layout="wide", initial_sidebar_state="collapsed")
...
if st.button("🔙 Kembali ke Halaman Utama", use_container_width=True):
    st.switch_page("home.py")  # ke halaman utama

# apps script
APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyBnOR9bb9mqfxE_d0w9o1krJSjpow7PCBe9x_QOKrcF_m7Zf8HaxHBFsfF9UFI_WfG/exec"
